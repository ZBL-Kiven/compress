...
class MainActivity : FragmentActivity() {
    ...
    private fun start() {
        AlbumIns.with(this).setOriginalPolymorphism(true).simultaneousSelection(true)
            .maxSelectedCount(1).mimeTypes(AlbumOptions.pairOf(AlbumOptions.ofVideo()))
            .videoSizeRange(100 * 1024, 200 * 1024 * 1024).start { _, data ->
